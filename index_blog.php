...
<body>
    ...
    <div class="container mt-5">
        ...
        <?php if(isset($_REQUEST['info'])){ ?>
            <?php if($_REQUEST['info'] == "added"){?>
                <div class="alert alert-success" role="alert" style='color:darkblue;background:lightblue;'>
                    <center><b>Blog has been added successfully</b></center>
                </div>
            <?php }?>
        <?php } ?>
        ...
        <div class="text-center">
            <a href="create_blog.php" class="btn" style='color:white;font: size 18px;background:darkblue;'><b>+ Create a new post</b></a>
                ...
                <div class="col-12 col-lg-4 d-flex justify-content-center p-3 my-3">
                    <div class="card" style='color:darkblue;background:lightblue;'>
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php echo substr($q['blog_content'], 0, 50);?>...</p>
                            <a href="view_blog.php?blog_id=<?php echo $q['blog_id']?>" class="btn" style='color:lightblue;font: size 18px;px;background:darkblue;'>Read More <span class="text-danger">&rarr;</span></a>
                        </div>
                    </div>
                </div>
            <?php }?>
